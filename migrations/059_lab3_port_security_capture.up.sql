-- Migration 059: Replace Lab 3 Harden simulated fixture with real IOU port-security captures
--
-- Console-truth captured from IOU L2 (i86bi-linux-l2-adventerprisek9-15.1a.bin)
-- on live GNS3, 2026-07-31. KALI eth1 → SW1 Et0/3, port-security enabled,
-- macof -i eth1 -n 10 triggered violation.
--
-- Replaces:
--   Step 2: adds syslog output showing the violation in real-time
--   Step 3: replaces descriptive text with actual show command output
