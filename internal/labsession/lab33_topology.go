...
// Lab 33 — Syslog (System Logging)
// Text: "R1 sends syslog messages, Kali runs syslog server"
// Same topology as SNMP — single router + Kali + PC
var Lab33Topology = TopologyTemplate{
	ComputeID: "local",
	Nodes: []NodeTemplate{
