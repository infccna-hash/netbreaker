...
// Lab 18 — CLI / SNMP / Management Access
// Topology: R1 (target), SW1 (management switch), PC1 (admin), KALI (attacker)
// PC1 accesses R1 via SSH/Telnet through the network.
// KALI sniffs management traffic and probes SNMP (public/private).
//
// Port mapping (IOU 4-port limit):
//   SW1: Et0/0=R1, Et0/1=PC1, Et0/2=KALI
var Lab18Topology = TopologyTemplate{
	ComputeID: "local",
	Nodes: []NodeTemplate{
		{
			Name:     "R1",
