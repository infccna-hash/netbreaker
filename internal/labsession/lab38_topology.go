...
// Topology: R1 (gateway) + SW1 (IOU L2 with snooping) + PC-A (DHCP client) + KALI (ARP spoofer)
// DAI validates ARP against the snooping binding table built in Lab 37.
var Lab38Topology = TopologyTemplate{
	ComputeID: "local",
	Nodes: []NodeTemplate{
		{
			Name:     "R1",
